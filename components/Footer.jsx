/**
 * Footer – theme-aware (CSS custom properties), social links, trust badges.
 */
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2 justify-center">
          {['Open Source', 'Powered by AI', 'Data-Driven'].map((b) => (
            <span key={b} className="trust-badge" style={{ fontSize: '0.78rem' }}>
              {b}
            </span>
          ))}
        </div>
